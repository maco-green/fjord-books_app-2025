...
class Report < ApplicationRecord
  ...
  has_many :mentioning_reports, through: :mentioning_mentions, source: :mentioning_report
  has_many :mentioned_reports, through: :mentioned_mentions, source: :mentioned_report
